...
{
    # https://github.com/linuxmobile/kaku/blob/1765a62063f355eb6bfe66c799d4f1bb60ddd6cb/system/programs/start-cosmic-ext-niri.nix
    # https://github.com/Drakulix/cosmic-ext-extra-sessions/issues/8
                        ...
                        pkgs.writeShellApplication {
                            ...
                            text = ''
                                ...
                                if [[ -z "''${DBUS_SESSION_BUS_ADDRESS}" ]]; then
                                    exec dbus-run-session -- ${pkgs.cosmic-session}/bin/cosmic-session ${pkgs.niri-stable}/bin/niri --session
                                else
                                    exec ${pkgs.cosmic-session}/bin/cosmic-session ${pkgs.niri-stable}/bin/niri --session
                                fi
                            '';
                        }

...
in
{
    ...
    config = lib.mkIf config.programs.sublime-merge.enable {
        ...
        programs = lib.mkIf config.catppuccin.sublime-merge.enable {
            ...
            sublime-merge = {
                settings.theme = "${catppuccinBaseName}.sublime-theme";
                userFile = {
                    "Commit Message - ${catppuccinBaseName}.sublime-settings".text = builtins.toJSON {
                        color_scheme = catppuccinColorScheme;
                    };
                    "Diff - ${catppuccinBaseName}.sublime-settings".text = builtins.toJSON {
                        color_scheme = catppuccinColorScheme;
                    };
                    "File Mode - ${catppuccinBaseName}.sublime-settings".text = builtins.toJSON {
                        color_scheme = catppuccinColorScheme;
                    };
                    "${catppuccinBaseName}.sublime-theme".text =
                        let
